...
`~/KukulaHipp`: Base repository includes README file and final report (.Rmd and PDF files)

`~/KukulaHipp/Data/Raw`: Includes all raw data downloaded for analysis 
  * Note: `/00_Extraneous_Data`: Includes datasets ultimately not used in the final report

`~/KukulaHipp/Analysis`: Analysis folder includes .Rmd files used for initial data wranging and analysis used ultimately in our final report
...
See the folder `~/KukulaHipp/Data/Metadata` for metadata of all datasets 
