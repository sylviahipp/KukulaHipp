...
Additionally, we obtained continuous streamflow data along the Elwha River from USGS's Water Data for the Nation. These data comprised of daily discharge and gage height from USGS monitoring station #12045500 (Elwha River at McDonald Bridge near Port Angeles, WA). For a discussion on data availability from this and other monitoring stations along the Elwha River, see **Exploratory Analysis** below. 
