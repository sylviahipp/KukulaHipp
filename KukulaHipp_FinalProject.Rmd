...
plot_grid(ssc_hist, load_hist, nrow = 2, ncol = 1, labels = c("A", "B"))
```
...
```{r echo=FALSE, warning=FALSE, fig.height=6, fig.cap='Trends in Daily Sediment Load and Concentration at USGS Site #12046260 (2011–2016)'}
