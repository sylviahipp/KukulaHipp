...
A time series analysis reveals whether there was a monotonic trend in discharge and gage height along the Elwha River before, during, and after dam removal. 

As is evident in **Figure 4**, both discharge and gage height follow seasonal patterns. **Figure 6** shows the decomposed trend component (in red) overlaying the recorded data for both discharge and gage height. From this figure, it appears that gage height increased during dam removal and decreased again following completion. This trend is less clear with regards to discharge.
...
For this analysis, discharge and gage height data are deseasoned. The seasonally adjusted time series for both datasets were then split into three periods: before the start of removal, during removal, and after removal was completed. A Mann Kendall Test was used to assess whether a monotonic trend was present in discharge and gage height levels during each period. Results of this analysis are outlined in **Table 3**. 
...
The results of this analysis indicate that there were significant monotonic trends to both discharge and gage height levels over all periods before, during, and after dam removal. From these results, it is difficult to isolate a specific response in streamflow as a result of dam removal. There is a particularly strong negative trend (tau = -0.39) in gage height levels after dam removal following a positive trend during dam removal, which may suggest that river height returned to an equilibrium following the completion of the dam removals. 

## III.B. Question 2. Is there a significant impact on sediment load and concentration following dam removal?

As show in **Figure 5** above and **Figure 7** below, suspended sediment levels appear to be heightened during dam removal compared to levels after removal. A two-sample t-test assesses whether there is a significant difference in mean sediment concentration during and after removal. 
...
A directional two-sample t-test compared the suspended sediment concentrations recording during dam removal (n = 1,077 days) and after removal (n = 766 days). **Table 4** shows a summary of average suspended sediment concentrations before and after removal. This t-test had a p-value of 2.44e-24 (H1 being that levels were higher during removal than after), which confirms that suspended sediment concentration was significantly higher in the Elwha River during dam removal relative to after dam removal. While dam removal released millions of tons of sediment trapped behind both dams, suspended sediment concentrations appear to reach an equilibrium several months following the completion of both dam removals. 
