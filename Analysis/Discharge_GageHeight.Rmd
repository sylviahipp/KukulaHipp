...
base_plot <- function(ymin, ymax, vjust){
  base_plot <- ggplot() + 
    ...
    annotate(geom = "text", x = ymd("2013-03-01"), y = ymax-vjust, size = 3,
...
# Gage Height
gage_height_plot <- base_plot(ymin = 9, ymax = 19.5, vjust = 0.75) +
  geom_line(data = gage_height_to_plot, 
            aes(x = date, y = value, color = data_type)) +
  labs(y = "Gage Height (ft)", 
       x = NULL,
       color = NULL,
       title = "Gage Height Recorded at USGS Site 12045500", 
       subtitle = "Elwha River, 2008–2016")
  
# Discharge
discharge_plot <- base_plot(ymin = 0, ymax = 15000, vjust = 1000) + 
  geom_line(data = discharge_to_plot, 
            aes(x = date, y = value, color = data_type)) + 
  labs(y = "Discharge (cfs)", 
       x = NULL,
       color = NULL,
       title = "Discharge Recorded at USGS Site 12045500", 
       subtitle = "Elwha River, 2008–2016")
