...
discharge_12045500 <- read.csv(here("Data/Raw/daily_discharge_ 12045500.csv"))
gage_12045500 <- read.csv(here("Data/Raw/field_measurements_12045500.csv"))

discharge_12045500$time <- mdy(discharge_12045500$time)
discharge_12045500 <- mutate(discharge_12045500, year = year(time))
discharge_12045500$value <- as.numeric(discharge_12045500$value)

ggplot(data = discharge_12045500 %>% filter(year > 2011 & year < 2020)) +
  geom_line(aes(x = time,y = value))

# Should calculate the mean discharge over the study period for the year, and the 25th and 75th percentile
