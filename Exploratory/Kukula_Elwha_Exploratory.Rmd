...
# Striped fill for elwha dam removal? didnt look very good imo
# geom_rect_pattern
#             pattern = "stripe",
#             pattern_fill = "#7cae00",
#             fill = 'transparent',
...
common_xlim <- c(as.POSIXct(paste0(discharge_start, '01:15:00', tz = "UTC")),
                 as.POSIXct(paste0(discharge_end, '01:15:00', tz = "UTC"))
) 
gage_common <- gage_elwha_plot + xlim(common_xlim)
discharge_common <- discharge_elwha_plot + xlim(common_xlim)

plot_grid(gage_common,
          discharge_common,
          nrow = 2)
```
